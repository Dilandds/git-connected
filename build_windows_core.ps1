# Build LYNS360 Core edition for Windows
# Usage: powershell -ExecutionPolicy Bypass -File build_windows_core.ps1

$ErrorActionPreference = "Stop"

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  LYNS360 Core - Windows Build" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
# Build
Write-Host "Building LYNS360 Core EXE..."
pyinstaller stl_viewer_windows_core.spec --clean --noconfirm
...
Write-Host ""
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "  Build complete - Core edition" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
