...
"""
PyInstaller spec file for LYNS Core macOS build — full editor minus
...
stl_viewer_mac.spec with LYNS360 -> LYNS360-Core renames.
"""
...
# Add splash screen images if they exist — Core's own splash first, then
# the same fallback chain as Commercial.
splash_image_paths = [
...
app = BUNDLE(
    coll,
    name='LYNS360-Core.app',
    icon=bundle_icon,
        bundle_identifier='com.ectoform.core',
    info_plist={
        ...
        # Same .lyns.pjt project file / UTI as Commercial — Core reads and
        # writes the exact same project format, just without "The Project"
        # section's own screens (see core/edition.py's is_core docstring).
