...
_FIELD_LABELS = {
    ...
    ('viewer_tabs', 'tab_name'): 'Tab Name',
    ('viewer_tabs', 'model_bytes'): 'Model File',
    ('viewer_tabs', 'model_ext'): 'Model File',
    ('viewer_tabs', 'drawings'): 'Drawings',
    ('viewer_tabs', 'annotations'): 'Annotations',
    ('viewer_tabs', 'render'): 'Render Style',
    ('viewer_tabs', 'image_bytes'): 'Screenshot',
